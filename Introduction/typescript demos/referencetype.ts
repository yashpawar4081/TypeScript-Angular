...
let numbers3 : number[] = [1,2,3,4,5,6];
...
//filter()  map()  reduce()
let numbers7 : number[] = [1,2,3,4, 45];

let numbers8 : (number | string)[] = [1,2,'saurabh','sanjay',2,4];

//tuple

let numbers9 :[number,string,string] = [10, 'saurabh', 'pune'];
